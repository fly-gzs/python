...
aminek kapcsán a felhasználó megpróbálja kitalálnia betűit.
"""
import random
lista = ['Enci', 'cica', 'csücsi', 'nyuszi', 'baba']
szo = random.choice(lista)
print('A véletlenszerüen kiválasztott szó: ', szo)
betu = None
lista_igen = []
lista_nem = []
while betu != '':
