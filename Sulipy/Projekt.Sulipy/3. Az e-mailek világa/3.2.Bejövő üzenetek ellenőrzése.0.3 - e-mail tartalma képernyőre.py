'''
Range függvénnyel beállítható az utolsó x db e-mail tartalmának kiíratása képernyőre.
Vigyázat!!!
...
def get_messages(service):
    ...
    for index in range(50):
        message = service.users().messages().get(userId='me', id=msg_ids[index], format='full').execute()
        ...
        try:
            ...
            print(f'{index} Ezzel a (message["payload"]["parts"][0]["body"]["data"]) beállítással  az üzenetet nem lehet megjeleníteni!')
